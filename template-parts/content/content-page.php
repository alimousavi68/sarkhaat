...
<div class="col-xl-17 col-md-24 col-sm-24 pe-0 ps-2 ps-lg-2 ps-sm-0 d-flex flex-column gap-3">
    <!-- breadcrumb -->
    <!-- <div class="box row d-flex py-2 mx-0 align-content-center">
        <?php //i8_breadcrumb(); 
        ?>
    </div> -->
    ...
    <section class="d-flex flex-column row-gap-3">
        ...
        <div class="box d-flex flex-xxl-row flex-xl-row flex-lg-row justify-content-between flex-column-reverse align-items-center">
            ...
            <div class="social-icons d-flex align-items-center">
                <a href="https://twitter.com/intent/tweet?url=<?php the_permalink(); ?>" alt="twitter share button">
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" alt="instagram share button" aria-label="instagram share button">
                ...
                <a href="https://t.me/share/url?url=<?php the_permalink(); ?>" alt="telegram share button" aria-label="telegram share button">
                ...
                <a href="https://wa.me/?text=<?php the_permalink(); ?>" alt="whatsapp share button" aria-label="whatsapp share button">
