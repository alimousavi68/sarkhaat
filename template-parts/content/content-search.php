...
<div class="row mx-0">
    <div class="col-xl-17 col-md-24 col-sm-24 pe-0 ps-2 ps-lg-2 ps-sm-0 d-flex flex-column gap-1 ">
        ...
        <div class="box row d-flex py-3 mx-0 align-content-center row-gap-1">
            ...
            <form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
                <div class="i8-wrapper">
                    <div class="i8-container">
                        <input type="search" class="i8-input w-100" placeholder="عبارت مورد نظر …" value="<?php echo get_search_query(); ?>" name="s" />
                        <button type="submit" class="i8-close-btn"><?php echo $icon_print; ?></button>
                    </div>
                </div>
            </form>
