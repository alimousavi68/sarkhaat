...
<div class="col-xl-17 col-md-24 col-sm-24  d-flex flex-column gap-3 ps-2 pe-0 ps-4 ps-xl-4 ps-lg-4 ps-sm-0">
    ...
    ?>
    <!-- breadcrumb -->
    <div class=" d-flex py-3 mx-0 align-content-center row-gap-3 border-bottom breadcrumb ">
        ...
        <div class="d-none d-xl-flex d-lg-flex d-md-flex  col-md-12 col-sm-24 mb-0 flex-row  justify-content-center justify-content-md-end text-gray f14">
            <div class="d-flex justify-content-center gap-0 gap-lg-0 gap-sm-1">
                ...
                <a class="p-0 p-lg-0 p-sm-1" href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" alt="instagram share button" aria-label="instagram share button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="var(--i8-light-primary)" class="bi bi-instagram mx-1" viewBox="0 0 16 16">
    ...
    <!-- intro -->
    <div class="article d-flex flex-row justify-content-between  ">
        <div class="row w-100 mx-0 d-flex flex-column-reverse flex-xl-row flex-lg-row flex-md-row row-gap-3">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-24 px-0 px-xl-2 px-lg-2">
                <a href="<?php the_permalink(); ?>"> <?php echo i8_the_thumbnail('i8-lg-440-310', 'hover w-100 rounded-15 object-fit-cover i8-h-md-100', $size=array('width'=>440,'height'=>310), true, 'max-height:275px;', false, true); ?></a>
            </div>
        </div>
    </div>
    ...
    <section class="d-flex flex-column row-gap-3">
        ...
        <div class=" d-flex flex-xxl-row flex-xl-row flex-lg-row justify-content-between flex-column-reverse align-items-start">
            ...
            <div class="social-icons d-flex justify-content-center gap-0 gap-lg-0 gap-sm-1">
                <?php if (get_post_meta(get_the_ID(), 'i8_show_date', true) == 'on') : ?>
                    <div class="d-flex align-items-center">
                        <p class="text-gray f14 m-0" style="line-height: 100%;padding-top: 5px;"><?php the_date('H:i - Y/m/d ') ?></p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="var(--i8-light-primary)" class="bi bi-calendar2 mx-1" viewBox="0 0 16 16">
                            <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM2 2a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H2z" />
                            <path d="M2.5 4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5V4z" />
                        </svg>
                    </div>
