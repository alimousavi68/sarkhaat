...
<div class="col-xl-17 col-md-24 col-sm-24 pe-0 ps-2 ps-lg-2 ps-sm-0 d-flex flex-column gap-3">
    ...
    <!-- intro -->
    <div class="article d-flex flex-row justify-content-between box ">
        <div class="row w-100 mx-0 d-flex flex-column-reverse flex-xl-row flex-lg-row flex-md-row row-gap-3">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-24 px-0 px-xl-2 px-lg-2">
                <a href="<?php the_permalink(); ?>"> <?php echo i8_the_thumbnail('i8-lg-440-310', 'hover w-100 rounded-15 object-fit-cover i8-h-md-100', 275, true, 'max-height:275px;', false, true); ?></a>
            </div>
        </div>
    </div>
    ...
    <section class="d-flex flex-column row-gap-3">
        ...
        <div class="box d-flex flex-xxl-row flex-xl-row flex-lg-row justify-content-between flex-column-reverse align-items-start">
