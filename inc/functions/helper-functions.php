...
?>
    <div class="d-flex">
        <div class="d-none d-xl-flex d-lg-flex d-md-flex justify-content-center gap-2 social-links ">
            <?php if ($twitter) :  ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $twitter; ?>" alt="twitter share button" aria-label="twitter share button">
            ...
            <?php endif; ?>
            <?php if ($facebook) :  ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $facebook; ?>" alt="facebook share button" aria-label="facebook share button">
            ...
            <?php endif; ?>
            <?php if ($telegram) :  ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" href="<?php echo $telegram; ?>" alt="telegram share button" aria-label="telegram share button">
            ...
            <?php endif; ?>
            <?php if ($whatsapp) :  ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $whatsapp; ?>" alt="whatsapp share button" aria-label="whatsapp share button">
            ...
            <?php endif; ?>
            <?php if ($instagram) :  ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $instagram; ?>" alt="instagram share button" aria-label="instagram share button">
            ...
            <?php endif; ?>
            <?php if ($youtube) :  ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $youtube; ?>" alt="youtube share button" aria-label="youtube share button">
            ...
            <?php endif; ?>
            <?php if ($aparat) :  ?>
                <a class="p-0 p-lg-0 p-sm-1 dark-btn" target="_blank" href="<?php echo $aparat; ?>" alt="aparat share button" aria-label="aparat share button">
